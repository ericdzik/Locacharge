...
// import 'package:flutter_localizations/flutter_localizations.dart'; // Supprimé
...
// import 'package:flutter_gen/gen_l10n/app_localizations.dart'; // Supprimé
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final manualTranslations = ManualTranslations(const Locale('fr')); // Locale par défaut
    return MaterialApp(
      title: manualTranslations.translate('appTitle'),
      ...
      // Configuration pour l10n - Supprimée
